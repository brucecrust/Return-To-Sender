                ...
                for (int i = 1; i < inventoryItemList.itemList.Count; i++)                      //get through all items which are there in the itemdatabase
                {
                    try
                    {
                        ...
                        if (manageItem[i])                                                                                                      //if you press on it you get this
                        {
                            ...
                            if (inventoryItemList.itemList[i].itemType == ItemType.Weapon)
                                inventoryItemList.itemList[i].weaponType = (WeaponType)EditorGUILayout.EnumPopup("Weapon Type", inventoryItemList.itemList[i].weaponType, GUILayout.Width(position.width - 45));            //Same as above but weapon type
